...
*/
     ...
     * @param move = the absolute movement desired for the particle, leave at 0, 0 if no movement is desired
     ...
     * 
     * @param args = the arguments of the function, every modifiable parameter is in it
